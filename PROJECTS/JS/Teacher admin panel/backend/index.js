 ...
 * @returns {{ name: string, surname: string, lastname: string, birth: string, course: string, faculty: string }} Объект студента
 */
function makeStudentFromData(data) {
  ...
  if (!student.birth)
    errors.push({ field: "birth", message: "Не указана дата рождения" });
  if (!student.course)
    errors.push({ field: "course", message: "Не указано начало обучения" });
  if (!student.faculty)
 ...
 * @returns {{ id: string, name: string, surname: string, lastname: string, birth: string, course: string, faculty: string }[]} Массив студентов
 */
 ...
 * @returns {{ id: string, name: string, surname: string, lastname: string, birth: string, course: string, faculty: string, createdAt: string, updatedAt: string }} Объект студента
 */
 ...
 * @param {{ name?: string, surname?: string, lastname?: string, birth?: string, course?: string, faculty?: string }} data - Объект с изменяемыми данными
 * @throws {ApiError} Студент с таким ID не найден (statusCode 404)
 * @throws {ApiError} Некорректные данные в аргументе (statusCode 422)
 * @returns {{ id: string, name: string, surname: string, lastname: string, birth: string, course: string, faculty: string, createdAt: string, updatedAt: string }} Объект студента
 */
